 ...
 * int size()                                                                *
 *                                                                           *
 * Returns the number of tiles stored in the library at this point.          *
 * ------------------------------------------------------------------------- */
int GraphicsLib::size()
{   return _tiles.size(); }
 ...
 *   t: The tile number                                                      *
 *                                                                           *
 * Returns a description of the tile based on its tileType() value.          *
 * ------------------------------------------------------------------------- */
string GraphicsLib::tileDesc(int t)
{
    int typ = tileType(t);
    switch (typ)
 ...
 *   t: The tile number                                                      *
 *                                                                           *
 * Returns a description of the tile based on its tileType2() value.         *
 * ------------------------------------------------------------------------- */
string GraphicsLib::tileDesc2(int t)
{
    int typ = tileType2(t);
    switch (typ)
